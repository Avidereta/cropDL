...
img = cv2.imread('/home/anastasia/cropDL/code/lesion.JPG', 0)
...
cv2.createTrackbar('lower', 'canny', 0, 179, nothing)
cv2.createTrackbar('upper', 'canny', 0, 179, nothing)
...
while(1):
    ...
    if s == 0:
        ...
        edges = cv2.inRange(img, lower, upper)
